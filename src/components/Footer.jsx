function Footer() {
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-t border-tealLight/20 mt-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start space-x-3 mb-4">
              ...
              <h3 className="text-2xl font-bold bg-gradient-to-r from-lightYellow to-tealLight bg-clip-text text-transparent">
                Task Flow
              </h3>
            </div>
          ...
          <div className="text-center">
            <h4 className="text-lg font-semibold text-lightYellow mb-4">
              Desenvolvido por
            </h4>
            <div className="space-y-2">
              <p className="text-xl font-bold text-white">Amanda Paulino</p>
              <p className="text-gray-400 text-sm leading-relaxed">Conectando teoria e prática em projetos próprios</p>
            </div>
          </div>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end space-x-4">
              ...
              <a
                ...
                className="group bg-gray-800/50 hover:bg-gray-700/50 p-3 rounded-xl transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group bg-gray-800/50 hover:bg-blue-600/20 p-3 rounded-xl transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
              ...
              <a
                ...
                className="group bg-gray-800/50 hover:bg-tealLight/20 p-3 rounded-xl transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
                title="Email - amandapaulinofranco@gmail.com"
              >
                <svg className="w-6 h-6 text-gray-400 group-hover:text-tealLight transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
